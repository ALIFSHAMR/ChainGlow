  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col h-full">
        <SheetHeader>
          <SheetTitle className="font-display">Shopping Bag</SheetTitle>
          <SheetDescription>
            ...
            <>
                  ...
                  <div key={item.variantId} className="flex gap-3 p-3 rounded-lg bg-secondary/50">
                    ...
                    <div className="flex flex-col items-end gap-2 flex-shrink-0">
                      ...
                      <div className="flex items-center gap-1">
                        <button onClick={() => updateQuantity(item.variantId, item.quantity - 1)} className="h-6 w-6 rounded border border-border flex items-center justify-center hover:bg-secondary">
              ...
              <div className="flex-shrink-0 space-y-3 pt-4 border-t">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-lg">{items[0]?.price.currencyCode} {totalPrice.toFixed(2)}</span>
                </div>
